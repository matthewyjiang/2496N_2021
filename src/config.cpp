...
pros::Motor left_roller_mtr(14, pros::E_MOTOR_GEARSET_18);
pros::Motor right_roller_mtr(15, pros::E_MOTOR_GEARSET_18, true);
pros::Motor indexer_mtr(16, pros::E_MOTOR_GEARSET_06);
pros::Motor depositor_mtr(17, pros::E_MOTOR_GEARSET_06, true);
